...
By no means this project is covering the complete Cucumber; rather it is only scratching the surface. So, topics covered are: -
        ...
        B. Feature Files (Feature, Scenario, Given , When, Then, And)
        C. Step Definition Files (Given , When, Then, And, Before, After)
        D. Cucumber Expression and Parameter types
        E. Data table 
        F. Background Scenario
        F. Tags - with NOT, AND and OR
